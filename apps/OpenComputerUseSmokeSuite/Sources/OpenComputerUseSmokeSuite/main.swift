...
enum OpenComputerUseSmokeSuite {
    ...
    private static func runFullSmoke(
        ...
        guard toolNames.count == 14,
              toolNames.contains("launch_app") else {
            throw SmokeError.message("Expected 14 tools including launch_app, got \(toolNames)")
        }
